...
const About = () => {
  return (
    <Container>
      ...
      <p>
        I grew up on the south east coast of the UK before spend six years in
        ...
        Gothenburg is a great city and I plan on spending a lot time here. While
        out here I decided to switch careers, and move into something completely
        new, which is where I discoverd Craft Academy and my journey began.
      </p>
      <p>
        Outside of coding I have hobbies including running, making use of Gothenburgs
        amazing nature, försöker lära sig svenska, and cooking as a way to relax.
      </p>
    </Container>
  );
};
