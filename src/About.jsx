...
const About = () => {
  return (
    <Container>
      ...
      <p>
        My journey into web developement began with the{" "}
        <a
          id="craftacademy"
        ...
        months. Currently only a couple weeks in, soon I should have more
      ...
      <p>
        ...
        completely new, which is when I discoverd Craft Academy and my journey
        began.
      </p>
      <p>
